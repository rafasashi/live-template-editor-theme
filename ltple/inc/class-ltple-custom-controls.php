<?php
/**
 * LTPLE Theme Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	*/
	 ...
	 * 
	 */
	class LTPLE_Theme_Custom_Section extends WP_Customize_Section {
		protected function get_theme_resource_url() {
			if( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * 
	 */
	 class LTPLE_Theme_Image_Checkbox_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'ltple-custom-controls-css', $this->get_theme_resource_url() . 'css/customizer.css', array(), '1.0.2', 'all' );
		}
		/**
	 ...
	 * 
	 */
	 class LTPLE_Theme_Text_Radio_Button_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * 
	 */
	class LTPLE_Theme_Image_Radio_Button_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * 
	 */
	class LTPLE_Theme_Single_Accordion_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'ltple-custom-controls-js', $this->get_theme_resource_url() . 'js/customizer.js', array( 'jquery' ), '1.0.2', true );
			wp_enqueue_style( 'ltple-custom-controls-css', $this->get_theme_resource_url() . 'css/customizer.css', array(), '1.0.2', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * 
	 */
	class LTPLE_Theme_Simple_Notice_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * 
	 */
	class LTPLE_Theme_Slider_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'ltple-custom-controls-js', $this->get_theme_resource_url() . 'js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0.2', true );
			wp_enqueue_style( 'ltple-custom-controls-css', $this->get_theme_resource_url() . 'css/customizer.css', array(), '1.0.2', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * 
	 */
	class LTPLE_Theme_Toggle_Switch_Custom_control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * 
	 */
	class LTPLE_Theme_Sortable_Repeater_Text_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		?>
		  <div class="sortable_repeater_control">
				...
				<div class="sortable_repeater sortable">
					<div class="repeater">
						<input type="text" value="" class="repeater-input" placeholder="<?php echo $this->placeholder; ?>" /><span class="dashicons dashicons-sort"></span><a class="customize-control-sortable-repeater-delete" href="#"><span class="dashicons dashicons-no-alt"></span></a>
					</div>
				</div>
	...
	/**
	 * Sortable Repeater Url Custom Control
	 * 
	 */
	class LTPLE_Theme_Sortable_Repeater_Url_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'sortable_repeater';
		...
		?>
		  <div class="sortable_repeater_control">
				...
				<div class="sortable_repeater sortable">
					<div class="repeater">
						<input type="url" value="" class="repeater-input" placeholder="https://" /><span class="dashicons dashicons-sort"></span><a class="customize-control-sortable-repeater-delete" href="#"><span class="dashicons dashicons-no-alt"></span></a>
					</div>
				</div>
				<button class="button customize-control-sortable-repeater-add" type="button"><?php echo $this->button_labels['add']; ?></button>
			</div>
	 ...
	 * 
	 */
	class LTPLE_Theme_Dropdown_Select2_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'ltple-select2-js', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js', array( 'jquery' ), '4.0.6', true );
			wp_enqueue_script( 'ltple-custom-controls-js', $this->get_theme_resource_url() . 'js/customizer.js', array( 'ltple-select2-js' ), '1.0.2', true );
			wp_enqueue_style( 'ltple-custom-controls-css', $this->get_theme_resource_url() . 'css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'ltple-select2-css', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css', array(), '4.0.6', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * 
	 */
	class LTPLE_Theme_Dropdown_Posts_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * 
	 */
	class LTPLE_Theme_TinyMCE_Custom_control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['ltpletinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['ltpletinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['ltplemediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * 
	 */
	class LTPLE_Theme_Google_Font_Select_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['ltplefontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class LTPLE_Theme_Customize_Alpha_Color_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'ltple-custom-controls-js', $this->get_theme_resource_url() . 'js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0.2', true );
			wp_enqueue_style( 'ltple-custom-controls-css', $this->get_theme_resource_url() . 'css/customizer.css', array( 'wp-color-picker' ), '1.0.2', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class LTPLE_Theme_Alpha_Color_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'ltple-custom-controls-css', $this->get_theme_resource_url() . 'css/customizer.css', array(), '1.0.2', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_theme_resource_url() . 'js/wp-color-picker-alpha.js', array( 'wp-color-picker' ), '1.0.2', true );
	 ...
	 * 
	 */
	 class LTPLE_Theme_Pill_Checkbox_Custom_Control extends LTPLE_Theme_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 *
	 */
	class LTPLE_Theme_Upsell_Section extends LTPLE_Theme_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ltple-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="ltple_theme_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'ltple_theme_url_sanitization' ) ) {
		function ltple_theme_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'ltple_theme_switch_sanitization' ) ) {
		function ltple_theme_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 */
	if ( ! function_exists( 'ltple_theme_sanitize_integer' ) ) {
		function ltple_theme_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'ltple_theme_text_sanitization' ) ) {
		function ltple_theme_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'ltple_theme_array_sanitization' ) ) {
		function ltple_theme_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'ltple_theme_hex_rgba_sanitization' ) ) {
		function ltple_theme_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgba' ) ) {
				...
				$input = 'rgba(' . ltple_theme_in_range( $red, 0, 255 ) . ',' . ltple_theme_in_range( $green, 0, 255 ) . ',' . ltple_theme_in_range( $blue, 0, 255 ) . ',' . ltple_theme_in_range( $alpha, 0, 1 ) . ')';
			}
			return $input;
		}
	}
	 ...
	 */
	if ( ! function_exists( 'ltple_theme_in_range' ) ) {
		function ltple_theme_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'ltple_theme_google_font_sanitization' ) ) {
		function ltple_theme_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'ltple_theme_date_time_sanitization' ) ) {
		function ltple_theme_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'ltple_theme_range_sanitization' ) ) {
		function ltple_theme_range_sanitization( $input, $setting ) {
			...
			return ltple_theme_in_range( $number, $min, $max );
		}
	}
